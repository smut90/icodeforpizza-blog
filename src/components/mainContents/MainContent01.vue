<template>
    <div id="nav-services" class="wrapper container-fluid">
        <ArticleSeries :series="series01" />
        <ArticleSeries :series="series02" />
    </div>
</template>
